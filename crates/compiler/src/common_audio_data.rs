...
impl CommonAudioData {
    ...
    pub fn dir_addr_range(&self) -> Range<u16> {
        Self::DIR_TABLE_ADDR..self.sfx_bc_addr
    }
    ...
    pub fn instruments_and_samples_size(&self) -> u16 {
        let sfx = self.sfx_bc_and_table_addr_range();
