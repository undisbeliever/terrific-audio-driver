...
use compiler::{
    ...
    path::SourcePathBuf,
    project::{
        About, BlockNumber, BrrEncoderSettings, BrrEvaluator, BrrLoopFilter, BrrSample,
        BrrSamplePitches, BrrSampleSource, BrrSource, DefaultSfxFlags, Project, SampleNumber,
        SampleTuning, Song, WaveSource,
    },
};
